...
class HTTPUpdateServer {
 public:
  explicit HTTPUpdateServer(bool serial_debug = true) : _serial_output(serial_debug), _server(nullptr), _username(_emptyString), _password(_emptyString), _authenticated(false) {}
  ~HTTPUpdateServer() {}
